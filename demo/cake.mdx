...
<Browser url="/simpleembed" loadUrl="/03" zoom={1} />
<Editor
  code="03.js"
  lang="html"
...
<Video src="speaker.webm" start={39} end={53} />
<Browser url="/simpleembed" loadUrl="/04" zoom={1} />
<Editor
  code="04.js"
  lang="html"
  tab="demo/simple.html"
...
<Video src="speaker.webm" start={39} end={53} />
<Browser url="/simpleembed" loadUrl="/05" zoom={1} />
<Editor
  code="05.js"
  lang="html"
  tab="demo/simple.html"
...
<Browser url="https://master.dev.looker.com/" loadUrl="https://master.dev.looker.com/" zoom={1} />
<Editor
  code="05.js"
  lang="html"
  tab="demo/simple.html"
...
```srt
only the case bc we are logged into Looker in another window. This is called "Private Embedding". It takes your existing regular Looker login session and applies it to iframes.

You can imagine this might be useful for a case where the users are your everyday colleagues, and you just want to embed a Look or a Dashboard into salesforce, or into some internal intranet. If we log out, see what happens.
```
...
```srt
we get an authentication error. So this super lightweight method
works alright if we're just surfacing our embeds to people that know
what Looker is, but it doesn't let us actually build an app or
experience around Looker.
...
<Browser url="/embedsdk" loadUrl="/06" zoom={0.8} />
<Editor
  code="06.js"
  lang="jsx"
  tab="demo/App.js"
  tabs={["demo/simple.html", "demo/App.js"]}
/>

```srt
so lets shake things up a bit and bring in the Looker Embed SDK to
build some more robust embeds. We'll start with a simple React App. If you're
not familiar with React, it's a javascript framework that lets you easily build
web apps and manage state. Pretty nice.
```

---

<Video src="speaker.webm" start={128.2} end={169.7} />
<Browser url="/embedsdk" loadUrl="/07" zoom={0.9} />
<Editor
  code="07.js"
  focus="4:5,10:11"
  lang="jsx"
...
```srt
So this is a React app. We won't explain it all, but basically you've got the ability
to write code in javascript (or typescript) and then build your HTML output in a
sort of combo between HTML and Javascript called "JSX". This is about all you need to know.
```

---

<Video src="speaker.webm" start={169.7} end={214} />
<Browser url="/embedsdk" loadUrl="/08" zoom={0.9} />
<Editor
  code="08.js"
  focus="2:3,8:10"
  lang="jsx"
...
```srt
We start by bringing in Looker Components, our design system and components library.
This generally just helps us make everything pretty :)
You'll notice we also imported the embed-sdk. This is an SDK we provide to make it a
lot easier to create embeds— It handles creation of and interaction with the Looker iFrames.
```

---

<Video src="speaker.webm" start={214} end={257.8} />
<Browser url="/embedsdk" loadUrl="/09" zoom={0.9} />
<Editor
  code="09.js"
  focus="16:40"
  lang="jsx"
...
```srt
We'll create a React component called "Embed" that wraps a simple Embed SDK initialization.
```
